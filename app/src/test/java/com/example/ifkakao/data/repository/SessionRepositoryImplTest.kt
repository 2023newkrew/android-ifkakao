    ...
    fun `getSessions는 sessionInfo의 형태로 예측한 결과값을 반환한다`() {
        ...
        val expected = SessionInfo(
            ...
            users = listOf<User>(
                User(
                    id = "phoebe.727",
                    intro = "크러스트유니버스 코어 데브 팀 어플리케이션 파트에서 개발을 하고 있는 피비입니다. " +
                            "개발자 뿐만 아니라 일반 사용자들도 클레이튼을 쉽게 사용할 수 있도록 돕기 위해 필요한 다양한 개발에 참여하고 있습니다.",
                    img = "https://mk.kakaocdn.net/dn/if-kakao/2022/speaker/phoebe.727@krust.jpg",
                )
            ),
            ...
            liveQnaUrl = "https://tech.kakao.com/ifkakao2022/?title=%EB%A9%94%ED%83%80%EB%" +
                    ...
                    "ent&id=49",
            liveChannelUrl = "",
            sessionVodLink = "https://youtu.be/dcq-MJB9uXw",
